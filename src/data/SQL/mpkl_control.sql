-- ------------------------------------------------------------------
-- Title: Control group: Retrieves the clinical data for the first 24 hours
...
DROP MATERIALIZED VIEW IF EXISTS MPKL_CONTROL CASCADE;
CREATE MATERIALIZED VIEW MPKL_CONTROL as
with cpap as
(
