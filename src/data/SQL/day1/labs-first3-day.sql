-- This query pivots lab values taken in the first 72 hours of a patient's stay

-- Have already confirmed that the unit of measurement is always the same: null or the correct unit

DROP MATERIALIZED VIEW IF EXISTS labsfirst3day CASCADE;
CREATE materialized VIEW labsfirst3day AS
SELECT
  pvt.subject_id, pvt.hadm_id, pvt.icustay_id, t_day
...
GROUP BY pvt.subject_id, pvt.hadm_id, pvt.icustay_id, t_day
ORDER BY pvt.subject_id, pvt.hadm_id, pvt.icustay_id, t_day;
